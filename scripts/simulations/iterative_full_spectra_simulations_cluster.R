...
saveRDS(tree, "./100_taxa_tree_sim.tre")
...
saveRDS(simulated_bm, "./bm_data_sim.tre")
saveRDS(simulated_ou, "./ou_data_sim.tre")
saveRDS(simulated_bmm, "./bmm_data_sim.tre")
saveRDS(simulated_oum, "./oum_data_sim.tre")
...
#save output
saveRDS(bm_fit_bm, "./bm_fit_bm.rds")
saveRDS(ou_fit_bm, "./ou_fit_bm.rds")
saveRDS(eb_fit_bm, "./eb_fit_bm.rds")
saveRDS(lam_fit_bm, "./lam_fit_bm.rds")

saveRDS(gic_comparison_bm_df, "./gic_comparison_bm_df.rds")
...
saveRDS(bm_fit_ou, "./bm_fit_ou.rds")
saveRDS(ou_fit_ou, "./ou_fit_ou.rds")
saveRDS(eb_fit_ou, "./eb_fit_ou.rds")
saveRDS(lam_fit_ou, "./lam_fit_ou.rds")

saveRDS(gic_comparison_ou_df, "./gic_comparison_ou_df.rds")
...
saveRDS(bm_fit_bmm, "./bm_fit_bmm.rds")
saveRDS(ou_fit_bmm, "./ou_fit_bmm.rds")
saveRDS(eb_fit_bmm, "./eb_fit_bmm.rds")
saveRDS(lam_fit_bmm, "./lam_fit_bmm.rds")

saveRDS(gic_comparison_bmm_df, "./gic_comparison_bmm_df.rds")
...
saveRDS(bm_fit_oum, "./bm_fit_oum.rds")
saveRDS(ou_fit_oum, "./ou_fit_oum.rds")
saveRDS(eb_fit_oum, "./eb_fit_oum.rds")
saveRDS(lam_fit_oum, "./lam_fit_oum.rds")

saveRDS(gic_comparison_oum_df, "./gic_comparison_oum_df.rds")
