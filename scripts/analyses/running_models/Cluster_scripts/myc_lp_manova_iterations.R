...
taskid
#read list of models
model_list <- readRDS("/home/jjantzen/scratch/R/output/myc_lp_models/92sp_binary/best_myc_lp_models_for_manovas_92sp.rds")
...
saveRDS(manova_output, paste0("/home/jjantzen/scratch/R/output/myc_lp_models/92sp_binary/manova_output_iteration", taskid, "_", best_models$best_model[taskid], "_model_.rds"))
  
saveRDS(df_output, paste0("/home/jjantzen/scratch/R/output/myc_lp_models/92sp_binary/manova_summary_dataframe_", taskid, ".rds"))
