...
for (j in 1:length(models)){
  model <- mvgls(spectra ~ myc*gf, data = data_spectra, tree = trees, model=models[j], error = TRUE)
  #assign output
  ...
  #save model itself
  saveRDS(model, paste0("/home/jjantzen/scratch/R/output/myc_gf_models/myc_gf_92sp_model_", models[j], "_iteration", taskid, ".rds"))
}

saveRDS(df_output, paste0("/home/jjantzen/scratch/R/output/myc_gf_models/model_parameters_myc_gf_92sp_teration", taskid, ".rds"))
