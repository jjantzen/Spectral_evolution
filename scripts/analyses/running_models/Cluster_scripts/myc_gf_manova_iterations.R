...
taskid
#read list of models
model_list <- readRDS("/home/jjantzen/scratch/R/output/myc_gf_models/best_myc_gf_models_for_manovas_92sp.rds")

#choose which models to use 
best_models <- readRDS("/home/jjantzen/scratch/R/input/iterations_myc/best_models_myc_gf_models_92sp.rds")
...
saveRDS(manova_output, paste0("/home/jjantzen/scratch/R/output/myc_gf_models/manova_output_iteration", taskid, "_", best_models$best_model[taskid], "_model_.rds"))
  
saveRDS(df_output, paste0("/home/jjantzen/scratch/R/output/myc_gf_models/manova_summary_dataframe_", taskid, ".rds"))
