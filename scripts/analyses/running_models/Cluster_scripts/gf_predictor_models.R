...
for (j in 1:length(models)){
  model <- mvgls(spectra ~ gf, data = data_spectra, tree = trees, model=models[j], error = TRUE)
  #assign output
  ...
  #save model itself
  saveRDS(model, paste0("/home/jjantzen/scratch/R/output/gf_models/92sp_binary/gf_model_92sp_", models[j], "_iteration", taskid, ".rds"))
}

saveRDS(df_output, paste0("/home/jjantzen/scratch/R/output/gf_models/92sp_binary/model_parameters_gf_92sp_iteration", taskid, ".rds"))
