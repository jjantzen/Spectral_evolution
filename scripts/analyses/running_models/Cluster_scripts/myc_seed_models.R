...
data_spectra <- readRDS("/home/jjantzen/scratch/R/input/iterations_myc/seed_plant_data_for_myc.rds")

new_trees <- readRDS("/home/jjantzen/scratch/R/input/iterations_myc/seed_plant_trees_for_myc.rds")
...
for (j in 1:length(models)){
  ...
  #save model itself
  saveRDS(model, paste0("/home/jjantzen/scratch/R/output/myc_models/seed_plants/myc_model_seed_plant_", models[j], "_iteration", taskid, ".rds"))
}

saveRDS(df_output, paste0("/home/jjantzen/scratch/R/output/myc_models/seed_plants/model_parameters_myc_seed_plant_iteration", taskid, ".rds"))
