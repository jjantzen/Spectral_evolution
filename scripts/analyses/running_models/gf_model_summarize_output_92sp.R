...
#for file in folder
files <- list.files("./analysis/gf_models/92sp_binary/parameters/", pattern="model_parameters", all.files=FALSE, full.names=TRUE)
...
#save output
saveRDS(output_sorted, "./analysis/gf_models/summarized_parameters_gf_models_92sp_binary.rds")

output_sorted <- readRDS("./analysis/myc_models/summarized_parameters_gf_models_92sp_binary.rds")
...
saveRDS(summary, "./analysis/gf_models/summary_gf_models_92sp_binary.rds")

summary <- readRDS("./analysis/gf_models/summary_gf_models_92sp_binary.rds")
...
saveRDS(stats, "./analysis/gf_models/stats_gf_models_92sp_binary.rds")

stats <- readRDS("./analysis/gf_models/stats_gf_models_92sp_binary.rds")
