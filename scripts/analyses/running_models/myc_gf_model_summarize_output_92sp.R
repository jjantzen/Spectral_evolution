...
#for file in folder
files <- list.files("./analysis/myc_gf_models/parameters/", pattern="model_parameters", all.files=FALSE, full.names=TRUE)
...
#save output
saveRDS(output_sorted, "./analysis/myc_gf_models/summarized_parameters_myc_gf_models_92sp.rds")

output_sorted <- readRDS("./analysis/myc_gf_models/summarized_parameters_myc_gf_models_92sp.rds")
...
saveRDS(best_models, "./analysis/myc_gf_models/best_models_myc_gf_models_92sp.rds")
best_models <- readRDS("./analysis/myc_gf_models/best_models_myc_gf_models_92sp.rds")
...
saveRDS(summary, "./analysis/myc_gf_models/summary_myc_gf_models_92sp.rds")

summary <- readRDS("./analysis/myc_gf_models/summary_myc_gf_models_92sp.rds")
...
saveRDS(stats, "./analysis/myc_gf_models/stats_myc_gf_models_92sp.rds")

stats <- readRDS("./analysis/myc_gf_models/stats_myc_gf_models_92sp.rds")
...
mean(best_models_eb$parameter[-which(best_models_eb$iteration %in% c())])
sd(best_models_eb$parameter[-which(best_models_eb$iteration %in% c())])
...
pdf("./output/model_assessment/myc_gf_92sp_parameter_distributions_binary.pdf", width = 10, height = 8)
par(mfrow=c(2,1))
best_only
all_models
dev.off()

jpeg("./output/model_assessment/myc_gf_92sp_parameter_distributions_binary.jpg", width = 6, height = 6, units = "in", res = 500)
