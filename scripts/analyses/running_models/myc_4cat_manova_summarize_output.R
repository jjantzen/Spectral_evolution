...
#for file in folder
files <- list.files("./analysis/myc_models/98sp_4cat/manovas/", pattern="*manova_summary*", all.files=FALSE, full.names=TRUE, include.dirs = FALSE)
...
#save output
saveRDS(output_sorted, "./analysis/myc_models/98sp_4cat/summarized_manovas_myc_models_98sp_4cat.rds")

output_sorted <- readRDS("./analysis/myc_models/98sp_4cat/summarized_manovas_myc_models_98sp_4cat.rds")
