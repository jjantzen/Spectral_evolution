...
#for file in folder
files <- list.files("./analysis/gf_models/parameters/", pattern=NULL, all.files=FALSE, full.names=TRUE)
...
#save output
saveRDS(output_sorted, "./analysis/gf_models/summarized_parameters_gf_models.rds")
...
best_models
#36 failed in model run
saveRDS(best_models, "./analysis/gf_models/best_models_gf_models.rds")
best_models <- readRDS("./analysis/gf_models/best_models_gf_models.rds")
...
saveRDS(summary, "./analysis/gf_models/summary_gf_models.rds")

summary <- readRDS("./analysis/gf_models/summary_gf_models.rds")
...
saveRDS(stats, "./analysis/gf_models/stats_gf_models.rds")

stats <- readRDS("./analysis/gf_models/stats_gf_models.rds")
