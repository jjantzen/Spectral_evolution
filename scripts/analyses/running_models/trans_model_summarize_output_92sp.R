...
#for file in folder
files <- list.files("./analysis/myc_models/transformed/", pattern="model_parameters", all.files=FALSE, full.names=TRUE)
...
#save output
saveRDS(output_sorted, "./analysis/myc_models/transformed/summarized_parameters_trans_models_92sp_binary.rds")

output_sorted <- readRDS("./analysis/myc_models/transformed/summarized_parameters_trans_models_92sp_binary.rds")
...
best_models <- best_models[-26,]

#26 failed in model run
saveRDS(best_models, "./analysis/gf_models/best_models_gf_models_92sp_binary.rds")
best_models <- readRDS("./analysis/gf_models/best_models_gf_models_92sp_binary.rds")
...
saveRDS(summary, "./analysis/myc_models/transformed/summary_trans_models_92sp_binary.rds")

summary <- readRDS("./analysis/myc_models/transformed/summary_trans_models_92sp_binary.rds")
...
saveRDS(stats, "./analysis/myc_models/transformed/stats_trans_models_92sp_binary.rds")

stats <- readRDS("./analysis/myc_models/transformed/stats_trans_models_92sp_binary.rds")
...
mean(best_models_eb$tree_height[c(1:15)])
sd(best_models_eb$tree_height[c(1:15)])
...
pdf("./output/model_assessment/gf_only_92sp_parameter_distributions_binary.pdf", width = 10, height = 8)
par(mfrow=c(2,1))
best_only
all_models
dev.off()

jpeg("./output/model_assessment/gf_only_92sp_parameter_distributions_binary.jpg", width = 6, height = 6, units = "in", res = 500)
