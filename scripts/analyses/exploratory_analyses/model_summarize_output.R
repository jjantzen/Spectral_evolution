...
#for file in folder
files <- list.files("./analysis/exploratory_models/all_five_traits/", pattern=NULL, all.files=FALSE, full.names=TRUE)
...
#save output
saveRDS(output_sorted, "./analysis/exploratory_models/all_five_traits/summarized_parameters_all5_models_exp.rds")

output_sorted <- readRDS("./analysis/exploratory_models/all_five_traits/summarized_parameters_all5_models_exp.rds")
...
for (i in 1:100){#length(unique(output_sorted$iteration))){
...
saveRDS(best_models, "./analysis/exploratory_models/all_five_traits/best_models_all5_models_exp.rds")

best_models <- readRDS("./analysis/exploratory_models/all_five_traits/best_models_all5_models_exp.rds")
...
saveRDS(summary, "./analysis/exploratory_models/all_five_traits/n_per_model_all5_models_exp.rds")

summary <- readRDS("./analysis/exploratory_models/all_five_traits/n_per_model_all5_models_exp.rds")
...
saveRDS(stats, "./analysis/exploratory_models/all_five_traits/stats_all5_models_exp.rds")

stats <- readRDS("./analysis/exploratory_models/all_five_traits/stats_all5_models_exp.rds")
...
#get trees
trees_all <- readRDS("./data/for_analysis/reduced_trees_exploratory.rds")
...
pdf("./output/model_assessment/all5_expl_parameter_distributions.pdf", width = 10, height = 8)
par(mfrow=c(2,1))
best_only
all_models
dev.off()

jpeg("./output/model_assessment/all5_expl_parameter_distributions.jpg", width = 6, height = 6, units = "in", res = 500)
