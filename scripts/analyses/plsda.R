...
write.csv(r, file = "./analysis/plsda/categories_count.csv")
...
pdf("./output/plsda_kappa_comparison_finding_ncomp_round2.pdf", height = 8, width = 10)
...
write.csv(prob_mean,"./analysis/plsda/PLSDA_T6_probmean_20comps.csv")
...
jpeg("./output/plsda_id_probability_by_myc_plot_round2_20comp.jpg", height = 5, width = 8, res = 500, units = "in")
...
write.csv(tab_mean,"./analysis/plsda/PLSDA_all_confumean_20comps.csv")
...
write.csv(tabs_perc,"./analysis/plsda/PLSDA_all_confuperc_20comps.csv")
...
write.csv(mm2, file = "./analysis/plsda/plsda_loadings_20comps.csv")
...
ggsave("./output/loadings_20comp.pdf", width = 12, height =8, dpi = 600 )
