...
# #save combo output
saveRDS(combo, "./analysis/pca_analysis/scores_for_all_reps_and_pcs_ang_only.rds")
...
jpeg("./output/PCAs/consensus_plots/scores_by_species_across_tree_reps_jitter_ang_only.jpg", width = 10, height = 8, units = "in", res = 600)
ggplot(combo)+
...
jpeg("./output/PCAs/consensus_plots/mean_pc1_scores_traitgram_myc_dataset_ang_only.jpg", height = 8, width = 4, units = "in", res = 600)
par(xaxt="n",yaxt="s")
...
jpeg("./output/PCAs/consensus_plots/mean_pc2_scores_traitgram_myc_dataset_ang_only.jpg", height = 8, width = 4, units = "in", res = 600)
par(xaxt="n",yaxt="s")
...
jpeg("./output/PCAs/consensus_plots/mean_pc3_scores_traitgram_myc_dataset_ang_only.jpg", height = 8, width = 4, units = "in", res = 600)
par(xaxt="n",yaxt="s")
...
jpeg("./output/PCAs/consensus_plots/mean_scores_traitgram_myc_dataset_pc123_ang_only.jpg", height = 8, width = 8, units = "in", res = 800)
#pdf("./output/PCAs/consensus_plots/mean_scores_traitgram_myc_dataset_pc123_ang_only.pdf", height = 8, width = 8)
